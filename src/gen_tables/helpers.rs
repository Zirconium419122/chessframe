...
pub fn diagonal(start: Square, end: Square) -> bool {
    let start_rank = start.rank().to_index() as i8;
    let start_file = start.file().to_index() as i8;
    let end_rank = end.rank().to_index() as i8;
    let end_file = end.file().to_index() as i8;
